					...
					<fo:table table-layout="fixed" width="3cm" height="2cm">
						...
						<fo:table-body>
							<fo:table-row height="0.3cm">
								<fo:table-cell number-columns-spanned="2" text-align="right" font-weight="bold" padding-top="2pt" border-width="0.02cm" display-align="center"><fo:block text-align="right" font-size="8pt">OCUPACION</fo:block></fo:table-cell>
							</fo:table-row>
							<fo:table-row height="0.3cm">
