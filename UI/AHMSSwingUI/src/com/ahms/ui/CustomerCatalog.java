 ...
 * @author jorge
 */
public class CustomerCatalog extends javax.swing.JDialog {
    ...
    public CustomerCatalog(java.awt.Frame parent, boolean modal, Users loged) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CustomerCatalog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CustomerCatalog dialog = new CustomerCatalog(new javax.swing.JFrame(), true, null);
