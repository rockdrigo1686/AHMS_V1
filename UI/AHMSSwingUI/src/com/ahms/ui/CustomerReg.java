...
public class CustomerReg extends javax.swing.JDialog {
     ...
     * @param customers
     */
    public CustomerReg(java.awt.Frame parent, boolean modal, MainFrm main, Customers customers) {
        super(parent, modal);
        mainLocal = main;
        this.parent = parent;
...
//                    cleanSearch();
    ...
    private void initComponents() {
        ...
        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/ahms/ui/resources/1445772615_file_search.png"))); // NOI18N
        ...
        jButton7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/ahms/ui/resources/1445773254_file.png"))); // NOI18N
