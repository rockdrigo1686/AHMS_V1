...
public class ChangeHistoryDlg extends javax.swing.JDialog {
    ...
    private AccountSearchDlg parent;
    private boolean flag = true;
    private List<AccountTransactions> accT = null;

    /**
     * Creates new form Change
     */
    public ChangeHistoryDlg(AccountSearchDlg parent, boolean modal, Account account, Rooms room, Users user) {
        super(parent, modal);
        initComponents();
    ...
    private void jbGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbGuardarActionPerformed
        ...
        if (response && (txtDesc.getText() != null && !"".equals(txtDesc.getText()))) {
            ...
            for (AccountTransactions accT1 : accT) {
                accT1.setAtrDteMod(dteMod);
                accT1.setAtrUsrMod(autUser);
                accT1.setRmsId(changeHistory.getChaRmA());
                actBound.update(accT1);
            }

            GeneralFunctions.sendMessage(this, UIConstants.SUCCESS_SAVE);
            parent.fillTable();
            mainFrm.configGrid(rmb.searchAll(new Rooms()));
            this.dispose();
        }
