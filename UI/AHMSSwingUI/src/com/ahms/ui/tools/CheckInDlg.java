 ...
 * @author rsoto
 */
public class CheckInDlg extends javax.swing.JDialog {

    /**
     * Creates new form Reservation
     */
    public CheckInDlg(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CheckInDlg dialog = new CheckInDlg(new javax.swing.JFrame(), true);
