				...
				<fo:block-container left="0.7cm" width="20cm" height="{$heightBodyRHC}" top="4cm" position="absolute" >
					<fo:block>
						...
						<fo:table-column column-width="4cm"/>
							<fo:table-body>
								<fo:table-row  height="0.3cm">
									<fo:table-cell number-columns-spanned="2"  background-color="Gainsboro"  text-align="left" border-width="0.02cm" border-left="solid" border-right="solid" border-bottom="solid" border-top="solid" font-weight="normal" padding-top="2pt" display-align="center"><fo:block font-size="6pt" text-align="center" font-weight="bold" start-indent="2pt">SERVICIO</fo:block></fo:table-cell>
									...
									<fo:table-cell number-columns-spanned="1"  background-color="Gainsboro"  text-align="left" border-width="0.02cm" border-left="solid" border-right="solid" border-bottom="solid" border-top="solid" font-weight="normal" padding-top="2pt" display-align="center"><fo:block font-size="6pt" text-align="center" font-weight="bold" start-indent="2pt">MONTO</fo:block></fo:table-cell>
								</fo:table-row>								
							</fo:table-body>
						</fo:table>
					</fo:block>
